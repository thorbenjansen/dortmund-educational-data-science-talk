...
const slideReferences = {
  ...
  "foreign-language-human-ratings": ["Keller, Jansen, et al. (2024)", "Lohmann, Jansen et al., 2025", "2,314 TOEFL argumentative essays from year 11 students", "Foreign-language argumentation rating task"],
  "situated-expectancy-value-ai": ["Jansen, Wigfield et al., 2025", "Situated Expectancy-Value Theory"],
...
const bibliographyEntries = new Map(Object.entries({
  ...
  "lohmann, jansen et al., 2025": ["Lohmann, J., Jansen, T., et al. (2025). Neural networks or linguistic features? Comparing different machine-learning approaches for automated assessment of essay traits. Manuscript in preparation."],
  "lohmann, jansen et al. (2025)": ["Lohmann, J., Jansen, T., et al. (2025). Neural networks or linguistic features? Comparing different machine-learning approaches for automated assessment of essay traits. Manuscript in preparation."],
