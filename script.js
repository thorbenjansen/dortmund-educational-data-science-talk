...
const slideReferences = {
  ...
  "foreign-language-human-ratings": ["Keller, Lohmann, Trüb, Fleckenstein, Meyer, Jansen, & Möller, 2024", "2,314 TOEFL argumentative essays from year 11 students", "Foreign-language argumentation rating task"],
  ...
  "feedback-question": ["Jansen et al. AI-feedback moderation studies", "Bahr, Höft, Lipnevich, Meyer, & Jansen, 2025", "Feedback engagement and student-characteristics framework"],
  "feedback-study-design": ["DARIUS effectiveness study procedure"],
  "feedback-main-result": ["Jansen et al., 2025: feedback from generative AI and engagement in text revision", "Fleckenstein, Jansen, Meyer, Trüb et al., 2024"],
  "feedback-mechanism": ["Jansen et al., 2024: comparing generative AI and expert feedback", "Bahr, Höft, Lipnevich, Meyer, & Jansen, 2025", "Bahr, Höft, Meyer, & Jansen, 2026", "Jansen et al., 2025: engagement in text revision"],
  "differential-effects": ["Jansen, Pünjer, Tanz, Schaller, & Höft, 2026", "Tanz, Pünjer, Höft, Schaller, & Jansen, submitted", "Supplement_Receptivity Study"],
