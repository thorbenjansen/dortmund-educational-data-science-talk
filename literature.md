# Literature and Project Anchors

This compact list supports the adaptive `Sources` control in the Dortmund Educational Data Science talk. It is organized by the talk blocks, with project and data anchors kept separate from publication anchors where the local wiki source note is not yet a clean APA record.

## Dortmund and Program Fit

- TU Dortmund call for the open-rank professorship in Educational Data Science.
- TU Dortmund / IFS profile: school development research, empirical educational research, large-scale assessment, learning and development processes.
- Faculty of Statistics bridge: longitudinal data, random effects, machine learning, learning analytics, and complex educational data structures.
- Research Statement Thorben Jansen TU Dortmund: Educational Data Science for writing, feedback, AI-supported learning, process data, and large-scale assessment.
...
- Jansen & Moeller, 2022: teacher judgments in school exams and the influence of lower-order thinking skills.
...
- Supplement_Receptivity Study: moderation and heterogeneity analyses for AI-supported writing feedback.
...
- Effective argumentation instruction course: scalable student-facing transfer from writing and argumentation research.

## Large-Scale Assessment and AI Process Data

- Gen-W project: Generative AI meets PISA; individual effects on writing processes and products in English as a foreign language.
- German PISA 2025 extension on argumentative writing with and without chatbot support.
- PISA product evidence: score distributions with and without chatbot access.
- PISA process evidence: keystrokes, writing intensity, paste events, and integration strategies.
- PISA content evidence: automated and human-interpretable coding of argumentation.

## Project Pipeline and Network Anchors

- DARIUS: Digital Argumentation Instruction for Science.
- KISS-Pro and teacher courses in the Lernen:digital network.
- Leseband+ project with Auridis Stiftung and Victor Rolff Stiftung.
- Generational AI Horizon Europe project.
- Research Center Agile PAIR, UA Ruhr, IFS, TU Dortmund Data Science programs, and Faculty of Statistics as Dortmund collaboration anchors.
